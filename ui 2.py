    ...
    try:
        ...
        if response.status_code == 200:
            ...
            st.markdown(
                ...
                h1, h2, h3, h4, h5, h6, p, .stMarkdown, .stTextInput > div > div > input {{
                    color: white !important;
                }}
...
st.markdown("Stay up to date with cutting-edge AI insights in sports.")
st.markdown("---")
